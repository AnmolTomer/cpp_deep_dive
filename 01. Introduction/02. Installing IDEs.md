...
Go to [MinGW](http://www.mingw.org/)  >> Click on Downloads and get the compiler from sourceforge website.
...
Another recommendation would be to use CodeBlocks IDE for windows.
...
**DevC++** : Go to [this link](https://www.bloodshed.net/dev/devcpp.html) to download and install DevC++.
